...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        G_sample, z_original,z_noised, epsilon_layer, delta_layer, z_noise = eddp_autoencoder(input_shape, n_filters, filter_sizes,z_dim, A_true_flat, Z_noise, var_G, epsilon_init,delta_init)
        ...
        for it in range(1000000000):
            ...
            if it % 1000 == 0:   
                ...
                G_sample_curr, re_fake_curr = sess.run([G_sample, G_hacked], feed_dict={X: Xt_mb, Z_noise: enc_noise})
