...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        G_sample, latent_z, z_noised, epsilon_layer, z_noise = edp_autoencoder(input_shape, n_filters, filter_sizes,z_dim, A_true_flat, Z_noise, var_A, var_G, init_epsilon, Z_S)
