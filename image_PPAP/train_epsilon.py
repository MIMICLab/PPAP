...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        G_sample,A_sample, z_original,z_noised, z_removed, epsilon_layer,  z_noise = dp_autoencoder(input_shape, n_filters, filter_sizes,z_dim, A_true_flat, Z_noise, var_G, epsilon_init)
