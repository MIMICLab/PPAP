...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        G_sample, A_sample, z_original,z_noised, epsilon_layer, z_noise = edp_autoencoder(input_shape, n_filters, filter_sizes,z_dim, A_true_flat, Z_noise, var_A, var_G, init_epsilon)
        ...
        for it in range(1000000000):
            ...
            summary, _, _, G_loss_curr, dp_epsilon_curr = sess.run([merged, A_solver,G_solver, G_loss, dp_epsilon],feed_dict={X: X_mb, Z_noise: enc_noise})
