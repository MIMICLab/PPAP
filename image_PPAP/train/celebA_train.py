...
with graph.as_default():
    ...
    with sess.as_default():
        ...
        G_G_sample, A_G_sample, G_pyramid, G_reverse_pyramid = autoencoder(input_shape, n_filters, filter_sizes, 3, A_true_flat, var_G)
        G_H_sample, A_H_sample, A_pyramid, A_reverse_pyramid = autoencoder(input_shape, n_filters, filter_sizes, 3, G_G_sample, var_H) 
